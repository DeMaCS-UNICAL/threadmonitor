...
class Controller:
    ...
    def addLock(self,lock):
        ...
        waitContainer= Canvas(container,background='#c9c6ab',highlightthickness=1, highlightbackground="black",width=self.containerWidth,height=int(self.containerHeight*(25/100)))
